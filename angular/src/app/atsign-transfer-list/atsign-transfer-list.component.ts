...
@Component({
  selector: 'app-atsign-transfer-list',
  templateUrl: './atsign-transfer-list.component.html',
  styleUrls: ['./atsign-transfer-list.component.css']
})
export class AtsignTransferListComponent implements OnInit {
  faCheck = faCheck;
  faEdit = faEdit;
  allAtsigns: any;
  ...
  displayedColumns: string[] = ['id', 'atsign', 'createdAt', 'newOwnerEmail' ];
  ...
  atsignTransferList(data) {
    ...
    this.userService.atsignTransferList(data).subscribe(
      res => {
